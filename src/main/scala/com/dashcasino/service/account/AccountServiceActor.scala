...
import com.dashcasino.service.account.logic.{ExternalWithdrawalActorLogic, ExternalDepositActorLogic, InternalDepositActorLogic, InternalWithdrawalActorLogic}
...
class AccountServiceActor(implicit val accountDao: AccountSqlDao, transactionDao: TransactionSqlDao,
                     walletService: WalletService, commandService: CommandService) extends Actor
